...
function toggleNaviDivs() {
    if (isNaviOut == false) {
        navigatorContainer.style.transform = 'rotate(0)';

        toTopDiv.style.opacity = '1';
        toTopDiv.style.zIndex = '1';
        toTopDiv.style.transform = 'translateY(-100px)';

        toReviewCon.style.opacity = '1';
        toReviewCon.style.zIndex = '1';
        toReviewCon.style.transform = 'rotate(-60deg) translateY(-100px) rotate(60deg)';

        toBottomDiv.style.opacity = '1';
        toBottomDiv.style.zIndex = '1';
        toBottomDiv.style.transform = 'rotate(-120deg) translateY(-100px) rotate(120deg)';

        youtubeDiv.style.opacity = '1';
        youtubeDiv.style.zIndex = '1';
        youtubeDiv.style.transform = 'translateY(100px)';

        isNaviOut = true;
    } else {
        navigatorContainer.style.transform = 'rotate(-180deg)';

        toTopDiv.style.opacity = '0';
        toTopDiv.style.zIndex = '-1';
        toTopDiv.style.transform = 'translateY(0)';

        toReviewCon.style.opacity = '0';
        toReviewCon.style.zIndex = '-1';
        toReviewCon.style.transform = 'rotate(-60deg) translateY(0) rotate(60deg)';

        toBottomDiv.style.opacity = '0';
        toBottomDiv.style.zIndex = '-1';
        toBottomDiv.style.transform = 'rotate(-120deg) translateY(0) rotate(120deg)';

        youtubeDiv.style.opacity = '0';
        youtubeDiv.style.zIndex = '-1';
        youtubeDiv.style.transform = 'translateY(0)';
...
//상품 이미지 원본 보기
function showFullMainImg() {
    fullImageContainer.style.display = 'flex';
    fullImageContainer.children[1].src = this.src;
}
