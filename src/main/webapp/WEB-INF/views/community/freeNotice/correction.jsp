	...
	<main>
		<form class="section" method="POST">
			<div class="section_header">
				...
				<textarea name="board_title" id="" class="section_header_headline" placeholder="제목을 입력하세요.">${data.board_title}</textarea>
			</div>

			<div class="section_main">
				<h1>내용</h1>
				<textarea name="board_text" id="content" class="section_main_write" placeholder="내용을 입력하세요.">${data.board_text}</textarea>
				<!-- 에디터 스크립트 -->
