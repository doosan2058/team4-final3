        ...
        <div class="registProductCon">
            <div class="registProductDiv">
                <table>
                    ...
                    <tr>
                        <td>카테고리 선택</td>
                        <td><select name="product_category_id" class="formInputs">
                    ...
                    <tr>
                        <td>브랜드 선택</td>
                        <td><select name="product_brand_id" class="formInputs">
                    ...
                    <tr>
                        <td>상품 재고량</td>
                        <td><input type="number" class="formInputs" name="product_stock" required="required"
                                   min="1" max="99"> 개
                        </td>
                    </tr>
                    <tr>
                        <td>상품 이름</td>
                        <td><input type="text" class="formInputs" name="product_name" required="required"
                                   maxlength="20"></td>
                    </tr>
                    <tr>
                        <td>상품 코멘트</td>
                    ...
                    <tr>
                        <td>상품 가격</td>
                        <td><input type="number" class="formInputs" name="product_price" id="" required="required"
                                   min="1" max="99999999"> 원
                        </td>
                    </tr>
                    <tr>
                        <td>상품 이미지(최대 3개)</td>
                    ...
                    <tr>
                        <td>상품 유튜브 주소</td>
                        <td><input type="text" class="formInputs" name="product_youtube_url" maxlength="100"></td>
                    </tr>
                    <tr>
                        <td>상품 배송일</td>
                        <td><input type="number" class="formInputs" name="product_delivery_day"
                                   required="required" min="1" max="10"> 일
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" class="btnDiv"><input type="submit" class="formBtns" value="등록" id="addBtn">
                        </td>
                    </tr>
                    </tbody>
                </table>
