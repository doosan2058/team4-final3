...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/shop/qna/sample_qna.css">
    <!--xeicon-->
...
<sampleQnaContainer>
    <div class="sampleQnaTop">
        <h1>자주 묻는 질문</h1>
    </div>
    <div class="sampleQnaDiv">
        <div class="sampleQnaInnerTop">
            <p>Q. 주문 취소 처리 후, 환불까지 얼마나 소요되나요?</p>
        </div>
        <div class="sampleQnaInnerBottom ">
...
<script src="/resources/js/shop/qna/sample_qna.js"></script>
</body>
