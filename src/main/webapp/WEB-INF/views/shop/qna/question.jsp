    ...
    <form method="post" action="question">
        ...
        <div class="question_Open">
            ...
            <div class="question_Open_Radio">
                <label for="question_Open_Radio1"><input type="radio" id="question_Open_Radio1" name="qna_public"
                                                         value="공개" checked>공개</label>
                <label for="question_Open_Radio2"><input type="radio" id="question_Open_Radio2" name="qna_public"
                                                         value="비공개">비공개</label>
            </div>
        </div>
