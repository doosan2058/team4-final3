        ...
        <c:forEach var="item" items="${draw}">
            <div class="oneDrawDiv">
                ...
                <div class="drawBtnDiv">
                    ...
                    <input type="button" value="수정하기" class="drawModifyBtn">
                    <input type="button" value="지원자 목록" class="showWinnerBtn">
                </div>
            </div>
        </c:forEach>
    </div>
    ...
    <div class="winnerListDiv">
        ...
        <div class="winnerListCountInfoDiv">
            <ul>
                <li>
                    <span>모집 정원</span>
                    <span class="reqruitSpan"></span> 명
                </li>
                <li>
                    <span>총 지원 인원</span>
                    <span class="applicationSpan"></span> 명
                </li>
                <li>
                    <span>현재 당첨 인원</span>
                    <span class="winningSpan"></span> 명
                </li>
            </ul>
        </div>
